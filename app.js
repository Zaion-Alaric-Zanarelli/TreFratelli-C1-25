...
en: {
    ...
    hero_title: "Tre Fratelli — Cellar & Restaurant",
    hero_sub: "Four generations of family history, among the dry-stone walls of Valtellina and the aromas of mountain cooking.",
    storia_title: "Our story",
    storia_text1: "Tre Fratelli traces its roots back to 1925, when Giovanni chose to cultivate Chiavennasca — the mountain Nebbiolo — on the terraced vineyards overlooking Tirano.",
    storia_text2: "Through economic crises, war, and the revival of alpine tourism, the family preserved a simple tradition: wine, hospitality, stonework, and patience.",
    storia_text3: "Today, the fourth generation carries on with the same idea: good wine with good food, in a place that smells of wood, bread, and valley air.",
    cantina_title: "The cellar",
    cantina_text: "Small, essential, carved into the rock. Controlled fermentations, ageing in oak barrels, and long resting times: the mountain asks for time, and we honour it.",
    ...
    vini_classic_item2: "Tre Chardonnay 2022 — Fresh white, apple and mountain-flower notes.",
    vini_classic_item3: "Merlot Tre Fratelli 2020 — Ripe fruit, hints of cocoa, soft tannins.",
    vini_note: "*Historic house labels, originally created as stylistic exercises for the restaurant.",
    vini_montagna_title: "Mountain & Tradition",
    vini_montagna_text: "Handcrafted wines inspired by the character of Valtellina: local grapes, manual harvesting, slow ageing. Each vintage tells the story of the climate and the work on the terraces.",
    ristorante_title: "The restaurant",
    ristorante_text1: "Simple, local mountain cuisine: pizzoccheri, local cured meats and cheeses, game when in season, and homemade desserts.",
    ristorante_menu: "Sample menu (indicative)",
    ristorante_item1: "Dish of the day (starter or main) — €12",
    ristorante_item2: "Valtellina platter — €10",
    ristorante_item3: "Pizzoccheri — €11",
    ristorante_item4: "Rustic cake — €5",
    galleria_title: "Gallery",
    dove_title: "Where to find us",
    dove_address: "Via S. Stefano, 55 — 28087 Tirano (SO), Italy",
    dove_note: "A short walk from the historic centre and the terraced vineyards. Limited parking on site.",
    contatti_title: "Contact",
    contatti_email: "Email: info@trefratelli.example · Telephone: +39 000 000 000",
    contatti_hours: "Indicative opening times: Thu–Mon 12:00–15:00 / 19:00–22:00 · Tue–Wed closed.",
    footer: "© 2025 Tre Fratelli Cellar & Restaurant · Demonstration, non-commercial website."
  }
}
